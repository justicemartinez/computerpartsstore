...
class PartTest {
    ...
    void getMinInv() {
        ...
        assertEquals(minInv, partIn.getMinInv(), "The minInv for partIn should match the set value");

        partOut.setMinInv(minInv);
        assertEquals(minInv, partOut.getMinInv(), "The minInv for partOut should match the set value");
    }
    @Test
    void setMinInv() {
        int minInv = 5;
    ...
    void getMaxInv() {
        ...
        assertEquals(maxInv, partIn.getMaxInv(), "The maxInv for partIn should match the set value");

        partOut.setMaxInv(maxInv);
        assertEquals(maxInv, partOut.getMaxInv(), "The maxInv for partOut should match the set value");
    }
    @Test
    void setMaxInv() {
        int maxInv = 10;
